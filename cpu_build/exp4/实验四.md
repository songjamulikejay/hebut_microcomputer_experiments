<h1><centern>实验四 实现部分指令集</centern></h1>
...
if __name__ == "__main__":
    ...
    cpu.memory[0:7] = ["MOV AX 1","MOV BX 3","TEST AX BX","AND AX 0","OR AX 1","XOR BX 3","NOT AX","HTL"] #指令段
...
![image-20241004224108016](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\image-20241004224108016.png)
...
![image-20241004224223168](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\image-20241004224223168.png)

~~~html
直接寻址 DS为1 指令为["MOV AX DS:[100]",'HLT'] 地址存储值为111
~~~

![image-20241007131233522](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\image-20241007131233522.png)

```html
寄存器间接寻址 DS为1 BX为100 指令为["MOV BX 100","MOV AX DS:[BX]",'HLT'] 地址存储值为111
```

![image-20241007131913246](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\image-20241007131913246.png)

```html
基址加变址寻址 DS为1 BX为84 SI为16 指令为["MOV BX 84","MOV SI 16","MOV AX [BX+SI]",'HLT'] 地址存储值为111
```

![image-20241007133427395](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\image-20241007133427395.png)

```html
相对寻址 DS为1 SI为16  指令为["MOV SI 16","MOV AX [SI+84]",'HLT']  地址存储值为111
```

![image-20241007133806991](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\image-20241007133806991.png)

```html
MOV PUSH POP XCHG 指令 ["MOV AX 88","MOV CX 99","PUSH AX","POP BX","XCHG AX CX",'HLT']
```

![image-20241007135549563](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\image-20241007135549563.png)

![image-20241007135605705](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\image-20241007135605705.png)

![image-20241007135616507](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\image-20241007135616507.png)

``` html
ADD,SUB,INC,DEC,MUL,DIV 指令  ["MOV AX 3","MOV BX 1","ADD AX BX","SUB AX BX","INC","DEC","MUL 2","DIV 2","HTL"]
```

![image-20241007145546360](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\image-20241007145546360.png)

```html
AND OR XOR TEST NOT 指令 ["MOV AX 1","MOV BX 3","TEST AX BX","AND AX 0","OR AX 1","XOR BX 3","NOT AX","HTL"]
```

![image-20241007150619029](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\image-20241007150619029.png)